			...
			<section class="contact-page-area section-gap">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-12">
							<form class="form-area " method="post" id="myForm"  class="contact-form text-right" action="{{ action ('Bakery@register_action') }}">
								{{csrf_field()}}
								<div class="row">
									<div class="col-lg-6 form-group">
										<input name="name" placeholder="Enter your name" value="{{ old('name') }}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" class="common-input mb-20 form-control" required="" type="text">
										@if ($errors->has('name'))
											{{ $errors->first('name') }}
										@endif
