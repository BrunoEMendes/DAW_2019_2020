...
<body>
    ...
    <div class="container col-lg-6 pt-5 pb-3 col-sm-6" id="detailimg">
        <div id="name"><h1>{{ $p->name }}</h1><h3>{{ $p->price }} €</h3></div>

        <div class="product-item">
            <div class="pi-pic">
                <div id="temporary_message"> added to the cart</div>
                <img src="{{ url('/') }}/{{ $p->image}}" alt=""></img>
                <div class="pi-links pt-2" style="position:initial">
